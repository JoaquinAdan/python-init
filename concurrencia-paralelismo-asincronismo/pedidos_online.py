orders = [
    ...
    {
        "order_id": 2,
        "items": [{"name": "Teclado", "price": 80}, {"name": "Monitor", "price": 300}],
    },
    {
        "order_id": 3,
        "items": [{"name": "Smartphone", "price": 700}, {"name": "Funda", "price": 20}],
    },
]
...
async def process_payment(order_id):
    print(f"Procesando paga para la orden {order_id}...")
